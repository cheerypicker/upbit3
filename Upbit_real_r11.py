...
# r5: git 업로드용임.    ip주소 211.196.254.138  (신림원룸) , 210.100.171.123 (화성이디야), 116.126.242.160(기숙사)  15.164.229.188,172.31.38.8 (aws) 3.36.63.40(aws), 175.197.81.89(신림이디야)
...
# git clone https://github.com/cheerypicker/upbit2.git
# Ubuntu 서버 명령어
...
# 백그라운드 실행: nohup python3 Upbit_real_r11.py > output.log &     ###파일이름바꿔주기
